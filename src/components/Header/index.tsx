      ...
      <div className={styles.header}>
        <div className={styles.menu}>
          <div className={styles.blockLeft}>
            <Link className={classNames(styles.logo)}
                  href={'/'}
                  onClick={onClose}
            >
              МИПО
          ...
          <div className={styles.blockMid}>
            ...
            <Link className={router.asPath === '/webinars' ? styles.activeLink : styles.text}
                  href={'/webinars'}
                  onClick={onClose}
            >
              Вебинары
            ...
            <Link className={router.asPath === '/contact' ? styles.activeLink : styles.text}
                  href={'/contact'}
                  onClick={onClose}
            >
              контакты
        ...
        <div className={openDirection || openAboutInstitute ? styles.content : 'hidden'}>
          <div className={styles.linksContent}>
            <div className={openDirection ? styles.contentDirection : 'hidden'}>
              <Link className={styles.link} href={'/'}>ВСЕ НАПРАВЛЕНИЯ</Link>
            </div>

            <div className={openAboutInstitute ? styles.contentAboutInstitute : 'hidden'}>
              {
                MenuAboutInstitute.map((item, index) => (
                  <Link key={index} className={styles.link} href={item.link}>{item.text}</Link>
                ))
              }
            </div>
          </div>
