...
import { testComments } from '../../../data/Mock/test'
    ...
    <section className={'container'}>
                  ...
                  <div className={styles.itemComment} key={index}>
                    <div className={styles.wrapperHeader}>
                      <div className={styles.wrapperImage}>
                        <Image src={item.image} alt={'icon'} fill />
                      </div>
                    ...
                    <div onClick={() => toggleModal(index)} className={styles.wrapperIndicator}>
                      <div className={styles.textIndicator}>ЧИТАТЬ ПОЛНОСТЬЮ</div>
      ...
      <Modal open={openModal} setHidden={setOpenModal}>
        <div className={styles.modalComment}>
          <div className={styles.wrapperHeader}>
            <div className={styles.wrapperAuthor}>
              <div className={styles.name}>{testComments[counterReviews].name}</div>

              <div className={styles.data}>{testComments[counterReviews].data}</div>
            </div>
          ...
          <div className={styles.modalDescription}>
            {testComments[counterReviews].description}
          </div>
        </div>
      </Modal>
    </section>
