...
import { CardCounter } from '../../Items/CardCounter/CardCounter'
      ...
      <div className={styles.wrapperItems}>
        {
          PaymentTab.map((item, index) => (
            <CardCounter count={index + 1} title={item.title} active={item.active} key={index} />
          ))
        }
      </div>
      ...
      <div className={styles.blockFormApplication}>
        <div className={styles.wrapperText}>
          ...
          <p className={styles.description}>
            Остались вопросы или не можете определиться с курсом? Оставьте свои контакты,
            мы свяжемся с вами и все расскажем.
          </p>
        </div>
        ...
        <div className={styles.wrapperForm}>
          ...
          <p className={styles.textPolitika}>Оформляя заявку, я согласен &nbsp;
