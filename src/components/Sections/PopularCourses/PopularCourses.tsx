...
import PopularCourse from '@/components/Items/PopularCourse';
import Modal from '@/components/Modal';
import PopUpContentProgram from '@/components/PopUpContentProgram';
...
export const PopularCourses = () => {
  ...
  const isData = (): Array<IFaculty> | [] => {
    const ivValidTitle = [
      ...new Set(coursesData.filter(item => item.popularCourses)),
      ...
      <div className={styles.bg}>
        <div className={'container'}>
          <div className={styles.wrapperAboutInstitute}>
            <h2 className={styles.headerIAboutInstitute}>
              об институте <br /> мипо
            </h2>
            ...
            <p className={styles.titleIAboutInstitute}>
              ...
              своей области. Получите практические навыки для продвижения в
            ...
            <div className={styles.wrapperIAboutInstitute}>
              {IAboutInstitute.map((item, index) => (
                <div
                  className={styles.cardIAboutInstitute}
                  key={index}
                  style={{
                    backgroundColor: `rgba(255,255,255, ${
                      valid === index + 1 ? 1 : 0.2 * (index + 1)
                    })`,
