    ...
    <footer className={styles.footer}>
      <div className={'container'}>
        <div className={styles.top}>
          <Link href={'/'} passHref>
            {toggleLogo ? <MobileLogoFooterSvg /> : <LogoFooterSvg />}
          </Link>
        ...
        <div className={styles.mid}>
          ...
          <div className={styles.block_2}>
            {MenuAboutInstitute.map((item, index) => (
              <Link className={styles.text} key={index} href={item.link}>
                {item.text}
              </Link>
            ))}
          </div>
          ...
          <div className={styles.block_3}>
            ...
            <Link href={'tel:+74951509924'} className={styles.text}>
              +7 (495) 150-99-24
            </Link>
            <Link href={'mailto:info@mipo.msk.ru'} className={styles.text}>
              info@mipo.msk.ru
            </Link>
          ...
          <div className={styles.block_4}>
            ...
            <p className={styles.description}>
              Оставьте свои контакты и наши специалисты проведут вам
              дистанционную экскурсию по нашим курсам, чтобы вы смогли выбрать
              именно тот, который отвечает вашим запросам
            </p>
