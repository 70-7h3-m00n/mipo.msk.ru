...
export const HeaderDefault = () => {
  ...
  return (
    <header className={styles.wrapperRelative} onMouseLeave={onClose}>
      <div className={'container'}>
        <div className={styles.header}>
            ...
            <div className={styles.blockLeft}>
              ...
              <button
                className={classNames(
                  openDirection ? styles.activeDirection : styles.btnDirection,
                  styles.text
                )}
          ...
          <div
            className={
              openDirection || openAboutInstitute ? styles.content : 'hidden'
            }
          >
            <div className={styles.linksContent}>
              <div
                className={openDirection ? styles.contentDirection : 'hidden'}
              >
              ...
              <div
                className={
                  openAboutInstitute ? styles.contentAboutInstitute : 'hidden'
                }
              >
                {MenuAboutInstitute.map((item, index) => (
                  <Link
                    key={index}
                    className={styles.linkAboutInstitute}
                    href={item.link}
                  >
                    {item.text}
                  </Link>
