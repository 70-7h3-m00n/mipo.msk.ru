...
export const PopularCourse = ({ title, image, setIsFaculty, isFaculty, setOpenPopUp }: Props) => {
  ...
  let isActive = isFaculty === title || hoverSvg
...

          {
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
              ...
              <path
                ...
                fill="white" />
              <path d="M36.8843 24.9636L10.8843 24.9636" stroke="white" strokeWidth="2.3" />
            </svg>
          }
        </div>
      </div>
