  ...
  return (
    <div className={styles.listItem}>
      ...
      <div className={classNames(styles.itemImage, styles.item2)}>
        <Image className={styles.image} src={urlDiploma} alt={'image'} sizes={''} />
      </div>

      <div className={classNames(styles.itemImage, styles.item3)}>
        <Image className={styles.image} src={urlDirectory} alt={'image'} sizes={''} />
      </div>

      <div className={classNames(styles.itemImages, styles.item4)}>
        <Image sizes={''} className={styles.image} src={urlStudent1} alt={'image'} />

        <Image sizes={''} className={styles.image} src={urlStudent2} alt={'image'} />
      </div>
    </div>
  )
}
