const listRedirects = [
  {
    ...
    destination:
      '/professions/prakticheskaya-psihologiya-m-sh-pp/geshtalt-terapevt-mba',
    permanent: true,
    statusCode: 301
  },
  {
  ...
  {
    source:
      '/professions/prakticheskaya-psihologiya-m-sh-pp/prakticheskij-psiholog',
    destination:
      '/professions/prakticheskaya-psihologiya-m-sh-pp/psiholog-seksolog-mba',
    permanent: true,
    statusCode: 301
  },
  {
    ...
    destination:
      '/professions/prakticheskaya-psihologiya-m-sh-pp/detskij-psiholog-mba',
    permanent: true,
    statusCode: 301
  },
  {
    source:
      '/professions/prakticheskaya-psihologiya-m-sh-pp/psiholog-konsultant',
    destination:
      '/professions/prakticheskaya-psihologiya-m-sh-pp/psiholog-art-terapevt-mba',
    permanent: true,
    statusCode: 301
  },
  {
    source:
      '/professions/prakticheskaya-psihologiya-m-sh-pp/psiholog-kognitivno-povedencheskij-terapevt',
    destination:
      '/professions/prakticheskaya-psihologiya-m-sh-pp/psiholog-kognitivno-povedencheskij-terapevt-mba',
    permanent: true,
    statusCode: 301
  },
  {
    source:
      '/professions/prakticheskaya-psihologiya-m-sh-pp/psiholog-praktik-po-metaforicheskim-kartam',
    destination:
      '/professions/prakticheskaya-psihologiya-m-sh-pp/psiholog-praktik-po-metaforicheskim-kartam-mba',
    permanent: true,
    statusCode: 301
  },
  {
    source: '/professions/prakticheskaya-psihologiya-m-sh-pp/semejnyj-psiholog',
    destination:
