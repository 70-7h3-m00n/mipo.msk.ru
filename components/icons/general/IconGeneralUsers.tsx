import stls from '@/styles/components/icons/general/IconGeneralUsers.module.sass'
import { TPropClassNames, TPropColor } from '@/types/index'
import cn from 'classnames'
import { colors } from '@/config/index'
import { IconContainer } from '@/components/layout'

type TIconGeneralUsersProps = TPropClassNames & TPropColor

const IconGeneralUsers = ({ classNames, color }: TIconGeneralUsersProps) => {
  return (
...
export default IconGeneralUsers
